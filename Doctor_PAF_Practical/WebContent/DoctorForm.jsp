                        ...
                        <form id="formItem" name="formItem">
                                ...
                                <div class="form-group" style="width: 510px; margin-left: 15px;">
                                 ...
                                 <div class="form-group" style="width: 510px; margin-left: 15px;">
                                     ...
                                     <select id = "docGender" name = "docGender" class="btn btn-outline-success btn-lg dropdown-toggle dropdown-toggle-split" style="width: 100%;" required>
                                ...
                                <div class="form-group" style="width: 510px; margin-left: 15px;">
                                     <label for="From">Select Specification :</label><br>
                                      <select id = "docSpec" name = "docSpec" class="btn btn-outline-success btn-lg dropdown-toggle dropdown-toggle-split" style="width: 100%;" required>
                                ...
                                <div class="form-group" style="width: 510px; margin-left: 15px;">
                                     <label for="From">Hospital :</label><br>
                                      <select id = "docHospital" name = "docHospital" class="btn btn-outline-success btn-lg dropdown-toggle dropdown-toggle-split" style="width: 100%;" required>
